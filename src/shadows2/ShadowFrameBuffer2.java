 ...
 *
 */
public class ShadowFrameBuffer2 
{
	 ...
	 */
	protected ShadowFrameBuffer2(int width, int height) 
	{
		this.WIDTH = width;
		this.HEIGHT = height;
	...
	private static int createDepthBufferAttachment(int width, int height) 
	{
		...
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL14.GL_DEPTH_COMPONENT16, width, height, 0, //depth bits
