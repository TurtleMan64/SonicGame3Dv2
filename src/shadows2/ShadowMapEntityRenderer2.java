...
public class ShadowMapEntityRenderer2 
{
	 ...
	 *            "view" matrix.
	 */
	protected ShadowMapEntityRenderer2(ShadowShader2 shader, Matrix4f projectionViewMatrix) 
	{
		this.shader = shader;
	...
	/**
	 * Renders entieis to the shadow map. Each model is individually rendered
	 * 		to the shadow map
	 * 
	 * @param entities
	 *            - the entities to be rendered to the shadow map.
	 */
	protected void render(ArrayList<Entity> entities) 
	{
		...
		for(Entity entity: entities) 
		{
			if(entity.getVisibility())
			{
				...
				for (int i = 0; i < numModels; i++)
				{
					...
					TexturedModel texturedModel = entity.getModel(i);
