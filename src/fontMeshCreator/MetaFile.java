...
public class MetaFile {
	...
	private void openFile(String filename)
	{
		try
		{
			//InputStream is = Class.class.getResourceAsStream("/res/"+filename+".fnt");
			//fileName = fileName.substring(1);
			//InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("res/"+filename+".fnt");
			InputStream is = new FileInputStream("res/"+filename+".fnt");
