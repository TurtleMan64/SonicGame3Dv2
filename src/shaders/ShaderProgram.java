...
public abstract class ShaderProgram 
{
	...
	protected void bindFragOutput(int attatchment, String variableName)
	{
		GL30.glBindFragDataLocation(programID, attatchment, variableName);
	}
	...
	private static int loadShader(String file, int type)
	{
		...
		try
		{
			...
			//InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream(newFilename);
