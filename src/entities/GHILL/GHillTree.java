...
public class GHillTree extends Entity
{	
	private static TexturedModel[] model = null;
	
	public GHillTree(Vector3f position, float rotation, float scale)
	{
	...
	public static void allocateStaticModels()
	{
		if (model == null)
		{
			model = ConvenientMethods.loadModel("Models/GreenHillZone/", "GreenHillTree");
		}
	}
