...
public class GHillTotemWings extends CollideableObject
{
	private static CollisionModel cmOriginal = null;
	private static TexturedModel[] modelTotem = null;
	
	public GHillTotemWings(Vector3f position, float rotation, float scale)
	{
	...
	public static void allocateStaticModels()
	{
		if (modelTotem == null)
		{
			modelTotem = ConvenientMethods.loadModel("Models/GreenHillZone/", "GreenHillTotemWings");
		}
		if (cmOriginal == null)
		{
