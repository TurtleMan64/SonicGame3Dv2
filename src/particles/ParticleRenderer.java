...
public class ParticleRenderer 
{
	...
	protected void render(Map<ParticleTexture, List<Particle>> particles, Camera camera, float brightness, int clipSide)
	{
		...
		switch (clipSide+1)
		{
			case 0: //side -1
				for (ParticleTexture texture : particles.keySet())
				{
					...
					shader.loadOpacity(texture.getOpacity());
	...
	private void prepare()
	{
		...
		GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA); //GL11.GL_ONE_MINUS_SRC_ALPHA
