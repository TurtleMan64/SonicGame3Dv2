...
public class Fbo 
{
	...
	private void initialiseFrameBuffer(int type) 
	{
		...
		{
			colourBuffer = createMultisampleColourAttatchment(GL30.GL_COLOR_ATTACHMENT0);
			colourBuffer2 = createMultisampleColourAttatchment(GL30.GL_COLOR_ATTACHMENT1);
		}
		else
		{
	...
	private void createDepthTextureAttachment() 
	{
		...
		GL11.glTexImage2D(GL11.GL_TEXTURE_2D, 0, GL14.GL_DEPTH_COMPONENT24, width, height, 0, GL11.GL_DEPTH_COMPONENT,  //depth bits
	...
	private int createMultisampleColourAttatchment(int attachment)
	{
		colourBuffer = GL30.glGenRenderbuffers();
		GL30.glBindRenderbuffer(GL30.GL_RENDERBUFFER, colourBuffer);
		GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, DisplayManager.getSamples(), GL11.GL_RGBA8, width, height);
	...
	private void createDepthBufferAttachment() 
	{
		...
		if(!multisampleAndMultiTarget)
		{
			GL30.glRenderbufferStorage(GL30.GL_RENDERBUFFER, GL14.GL_DEPTH_COMPONENT24, width, height); //depth bits
		}
		else
		{
			GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, DisplayManager.getSamples(), GL14.GL_DEPTH_COMPONENT24, width, height);  //depth bits
		}
